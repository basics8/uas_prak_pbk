  ...
  <nav class="navbar">
    ...
    <div class="task-links">
      <div class="dropdown" @click="toggleDropdown">
        <div class="navbar-item">Tugas Dimas AlQhifari ▼</div> <!-- Menambah panah ke bawah -->
        <div class="dropdown-menu" :class="{ 'is-active': isDropdownActive }">
          <a href="https://dimas-projectcv.web.app/" class="navbar-item" target="_blank">TUGAS 1</a>
          <a href="https://dimas-tugas2-pbk.web.app/" class="navbar-item" target="_blank">TUGAS 2</a>
          <a href="https://tugas3-pbk-dimas.web.app/" class="navbar-item" target="_blank">TUGAS 3</a>
          <a href="https://tugas4-prakpbk-two.vercel.app/" class="navbar-item" target="_blank">TUGAS 4</a>
          <a href="https://tugas5-pbk-dimas.vercel.app/" class="navbar-item" target="_blank">TUGAS 5</a>
          <a href="https://pbk-tugas6-two.vercel.app/" class="navbar-item" target="_blank">TUGAS 6</a>
          <a href="https://tugas7-pbk.vercel.app/" class="navbar-item" target="_blank">TUGAS 7</a>
        </div>
      </div>
    </div>
  </nav>
